...
def seed_all(bcrypt_instance):
    _run_seed(bcrypt_instance)
...
def _run_seed(bcrypt):
    ...
    # Posts
    posts_data = [
        {"an": "Delhi Public School (DPS), R.K. Puram", "aa": ":school:", "as": "CBSE Affiliated Registry", "t": "Official Announcement: Zonal CBSE Innovation Exhibits", "c": "Our scientific advisory board invites all students to showcase projects.", "b": "DPS RK PURAM BULLETIN", "l": 138, "tg": ["DPSRKPuram", "ScienceZonals"]},
    ...
    # Opportunities
    opps = [
        {"name": "Ignite National Teen Innovation Hackathon 2026", "type": "Hackathon", "prov": "Innovation Council of India", "prize": ":500,000", "desc": "National prototype building contest for Grade IX-XII.", "elig": "Teams of 2-4 school pupils.", "dead": "June 15, 2026"},
